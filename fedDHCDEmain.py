from flearn.experiments.fedDH_CDE import FedHACDE
...
def main():
    ...
    t = FedHACDE(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
