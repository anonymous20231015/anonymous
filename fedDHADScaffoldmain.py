from flearn.experiments.fedDHADScaffold import *
...
def main():
    ...
    t = FedDHADScaffold(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
