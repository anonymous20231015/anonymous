...
echo ${model}
  nohup python ../scaffoldmain.py --iid 0 --equal ${equal} --unequal ${unequal} --unbalance ${unbalance} --dataset ${dataset} \
    --result_dir ${dir_name} --epochs ${epochs} --local_bs ${local_bs} --local_ep ${local_ep} --decay ${decay}\
    --model ${model} --l ${l} --optim ${optim} --seed ${seed} --control ${control} --dirichlet ${dirichlet}\
