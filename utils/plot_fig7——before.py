...
plt.legend(prop={'size': 8}, loc='center right',bbox_to_anchor=(1.30, 0.5)).get_frame().set_edgecolor('black')

plt.xticks([])
# plt.xticks([7, 23], ['Modest Heterogeneity', 'Highly Heterogeneity'], fontsize=11)
plt.xticks([7, 23], ['100 devices', '200 devices'], fontsize=18)
# plt.xticks([7, 23], ['Modest Communication', 'Poor Communication'], fontsize=11)
# plt.ylabel('Time (ms)')
