...
DHSca_acc_file_path = os.path.join(root_path, f"result/{data_name}/{model_name}/seed{seed}/fedDH-m3{seed}_{distribution}_lam-decay{DHSca_lam_decay}_b-decay{DHSca_b_decay}/{DHSca_lam_lr}/{DHSca_b_lr}", f"_test_accuracy.txt")
...
def test():
    ...
    # plt.plot(DHAD_time[:location], DHAD[:location], label='FedDHAD')
    # plt.plot(DHADSca_time[:location], DHADSca[:location], label='FedDHADScaffold')
    # plt.plot(fedavg_time[:location], fedavg[:location], label='FedAvg')
    # plt.plot(fedavg_time[:location], prox[:location], label='FedProx')
    # plt.plot(fedavg_time[:location], nova[:location], label='FedNova')
    # plt.plot(fedavg_time[:location], scaffold[:location], label='Scaffold')
    # plt.plot(fedavg_time[:location], moon[:location], label='MOON')
    # plt.plot(fedavg_time[:location], dyn[:location], label='FedDyn')
    plt.plot([i / 1000 for i in fedavg_time[:location]], DH[:location], label='FedDH')
    plt.plot([i / 1000 for i in fedavg_time[:location]], DHSca[:location], label='FedJS')
    ...
    plt.tight_layout()
    if pdf:
        plt.savefig(f'FedDHE_{data_name}_{model_name}.pdf')
    else:
        plt.show()
