...
class FedJS(object):
    ...
    """
    def __init__(self, args, iid, equal=True, unequal=False, unbalance=False, dirichlet=False, l=2, result_dir="fedJS"):
    ...
    def niid_aggregation(self, w, idx):
        ...
        for i in range(0, len(w)):
            print("client {} | Non-iid degree: {} | lambda {}; b {}".format(idx[i], self.niid_degree[idx[i]], self.lambdas[idx[i]], self.b[idx[i]]))
...
if __name__ == '__main__':
    args = args_parser()
    t = FedJS(args, iid=False, equal=False, unequal=False, unbalance=False, dirichlet=True)
    t.train()
