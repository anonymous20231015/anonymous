...
class FedDHS(object):
    ...
    """
    def __init__(self, args, iid, equal=True, unequal=False, unbalance=False, dirichlet=False, l=2, result_dir="fedDHS"):
...
if __name__ == '__main__':
    args = args_parser()
    t = FedDHS(args, iid=False, equal=False, unequal=False, unbalance=False, dirichlet=True)
    t.train()
