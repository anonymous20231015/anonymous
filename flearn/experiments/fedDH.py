...
# from flearn.models import resnet, lenet
...
class FedDH(object):
    ...
    """
    def __init__(self, args, iid, equal=True, unequal=False, unbalance=False, dirichlet=False, l=2, result_dir="fedDH"):
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            print(len(local_weights), len(local_grads))
            # 无效轮
            ...
            if (epoch + 11) % 10 == 0 or epoch == self.args.epochs - 1:
                ...
                save_result(self.args, os.path.join(result_path, str(self.args.lr_b), "_control_lambda.txt"), str(self.lambdas))
                save_result(self.args, os.path.join(result_path, str(self.args.lr_b), "_control_b.txt"), str(self.b))
...
if __name__ == '__main__':
    args = args_parser()
    t = FedDH(args, iid=False, equal=False, unequal=False, unbalance=False, dirichlet=True)
    t.train()
