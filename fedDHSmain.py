from flearn.experiments.fedDHS import FedDHS
...
def main():
    ...
    t = FedDHS(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
