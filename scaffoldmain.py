from flearn.experiments.scaffold import *
...
def main():
    ...
    t = Scaffold(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
