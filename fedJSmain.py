from flearn.experiments.fedJS import FedJS
...
def main():
    ...
    t = FedJS(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
