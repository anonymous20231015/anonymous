from flearn.experiments.fedDHScaffold import FedDHScaffold
...
def main():
    ...
    t = FedDHScaffold(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
