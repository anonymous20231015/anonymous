from flearn.experiments.fedDHAD import *
...
def main():
    ...
    t = FedDHAD(args, iid=iid, equal=equal, unequal=unequal, unbalance=unbalance, dirichlet=dirichlet, l=l, result_dir=result_dir)
    t.train()
